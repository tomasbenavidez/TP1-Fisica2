...
resistencia_10k['Error abs'] = resistencia_10k['Residuos'].abs()
...
plt.plot(resistencia_10k['Voltaje (V)'].tolist(), resistencia_10k['Corriente Teórica (A)'].tolist(), label='Teórica', color='orange')
...
plt.errorbar(
    resistencia_10k['Voltaje (V)'],
    resistencia_10k['Corriente (A)'],
    yerr=resistencia_10k['Error abs'],
    fmt='o',
    label='Error abs',
    color='darkblue',
    ecolor='gray',
